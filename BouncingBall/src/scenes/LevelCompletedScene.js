	...
	create() {
		...
		if (this.isWin) {
			...
			if (this.winImage !== null) {
				...
				const image = this.add.sprite(midX, scoreText.y + scoreText.height + 50, key)
					.setOrigin(0.5, 0)
				const height = image.height;
				const maxHeight = WorldHeight - (scoreText.y + scoreText.height + 100);
